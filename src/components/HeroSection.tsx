		...
		>
			<div className="absolute inset-0 pointer-events-none">
				...
				<div
					...
					style={{
						backgroundImage:
							"linear-gradient(oklch(0.45 0.0374 140.07) 1px, transparent 1px), linear-gradient(90deg, oklch(0.45 0.0374 140.07) 1px, transparent 1px)",
						backgroundSize: "40px 40px",
						backgroundPosition: "-1px -1px",
						opacity: isHovering ? 1 : 0,
						maskImage: isHovering
							? `radial-gradient(800px circle at ${mousePos.x}px ${mousePos.y}px, black, transparent 8%), linear-gradient(to left, black 0%, transparent 100%)`
							: "none",
